<div class="space-y-6">
    ...
    <!-- SweetAlert2 Konfirmasi Hapus Surat Masuk -->
    <script>
        function confirmDelete(id, nomor) {
            const dark = document.documentElement.classList.contains('dark');
            Swal.fire({
                title: 'Konfirmasi Hapus?',
                text: 'Apakah Anda yakin ingin menghapus naskah surat No. "' + nomor + '"? Tindakan ini tidak dapat dibatalkan.',
                icon: 'warning',
                ...
                if (res.isConfirmed) {
                    Livewire.dispatch('hapus-surat-masuk', { id: id });
                }
            });
        }
    </script>
