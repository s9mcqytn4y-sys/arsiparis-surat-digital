<div class="relative" x-data="{ open: @entangle('isOpen') }">
    <button
        ...
        class="relative p-2 rounded-md text-slate-600 hover:text-slate-900 hover:bg-slate-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-900 transition-colors min-h-10 min-w-10 flex items-center justify-center"
    >
